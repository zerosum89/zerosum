...
The homepage exposes a short recent-news window, so the stored anchor may not appear in the visible list. v018 allows profile-specific date fallback:
