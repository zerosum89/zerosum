...
AUDIT_VERSION = "github_actions_v045"
HIGHLIGHT_POLICY = (
...
def main() -> int:
    ...
    print(f"[v045] major/highlight audit rows={len(rows)} issues={issue_count} reviews={review_count} xlsx=major_quality_audit.xlsx")
    return 0
